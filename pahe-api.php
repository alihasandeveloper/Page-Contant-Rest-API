...
function get_used_block_files($request) {
...
function register_block_file_api() {
    register_rest_route('gutenberg/v2', '/blocks-js/', [
        'methods' => 'GET',
        'callback' => 'get_used_block_files',
        'permission_callback' => '__return_true',
    ]);
}
add_action('rest_api_init', 'register_block_file_api');

function get_uploaded_css_files($request) {
...
function register_uploads_css_api() {
    register_rest_route('gutenberg/v2', '/blocks-css/', [
        'methods' => 'GET',
        'callback' => 'get_uploaded_css_files',
        'permission_callback' => '__return_true',
    ]);
}
add_action('rest_api_init', 'register_uploads_css_api');
